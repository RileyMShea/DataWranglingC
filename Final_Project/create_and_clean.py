...
def main():
    ...
    file_name = r"rochester_sample.osm"
    ...
    with open("rochester_sample.json", 'w') as f:
        f.write(json_osm)
...
j2m.main(json_file="rochester_sample.json")

# setup connection for data exploration and cleaning
osm_col = get_col(collection="rochester_sample")  # type: MongoClient
